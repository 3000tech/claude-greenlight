...
- [ ] **README screenshot** — capture the overlay with 2-3 live sessions (standard + compact mode) and embed it at the top of the README. Highest-impact single improvement for a visual tool.
